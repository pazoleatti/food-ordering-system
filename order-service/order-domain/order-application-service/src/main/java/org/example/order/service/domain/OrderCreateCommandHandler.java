...
public class OrderCreateCommandHandler {
    ...
    public CreateOrderResponse createOrder(CreateOrderCommand createOrderCommand) {
        ...
        CreateOrderResponse createOrderResponse = orderDataMapper
                .createOrderToOrderResponse(orderCreatedEvent.getOrder(), "Order Created Successfully!");
        paymentOutboxHelper
                .savePaymentOutboxMessage(orderDataMapper.orderCreatedEventToOrderPaymentEventPayload(orderCreatedEvent),
