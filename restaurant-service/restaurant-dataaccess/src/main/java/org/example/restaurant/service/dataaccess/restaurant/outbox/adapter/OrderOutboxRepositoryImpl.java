package org.example.restaurant.service.dataaccess.restaurant.outbox.adapter;

import org.example.outbox.OutboxStatus;
import org.example.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import org.example.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import org.example.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import org.example.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import org.example.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
